	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="Signup_process.php" method="post" class="login100-form validate-form">
					<span class="login100-form-title">
						Email Verification
					</span>

					<div class="wrap-input100 validate-input" data-validate = "OTP is required">
					<input class="input100" type="text" name="user_otp" placeholder="Enter OTP" maxlength="4">
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="otp_submit" value="Submit" class="login100-form-btn">
